...
def setup_logger(log_file_path='scenery/logs/scenery_process.log', name='scenery_processor'):
    """
    配置日志系统，输出到文件和控制台
    ...
    # 创建文件 handler，使用 RotatingFileHandler 支持日志轮转
    ...
    file_handler.setLevel(logging.INFO)   # 写入到文件的日志，最小级别为 INFOR
